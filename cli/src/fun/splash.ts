...
const PERSONAL_SPLASHES: SplashOpts = [
    ...
    ['Some time day is gray, and you look in sky, and there is cloud', 'Tuap 2017'],
...
const SPLASH_OPTS: SplashOpts = [
    ...
    ['Sometimes we create our own heartbreaks through expectations.', 'Violet Evergarden'],
    /** Tales from the Hood */
    ...
    /** Bocchi the Rock */
    ["It might not resonate with all, but those that it does, it'll hit deep.", 'Ryo Yamada'],
    /** Bocchi the Rock */
    ["Actually, I'm pretty exhausted from all this social interaction, so I'm gonna go", 'Hitori Gotou'],
    /** UMU UMU, Fate */
